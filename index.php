...
if (isset($_POST['submit'])){
  ...
  $address = $_POST['address'];
    ...
    $query = "INSERT INTO cheack_out (full_name, phone_number,email,area,total_ammount, address) VALUES ('$full_name', '$phone_number', '$email', '$area', ' $total_ammount', '$address')";
  ...
  <div class="container">
      ...
      <form action="" method="post" class="Cheackout-form mt-5">
          <div class="mb-3 mt-5">
              ...
              <input type="text" class="form-control" name="full_name" value="" id="" placeholder="Your full name*" required>
          </div>
          <div class="mb-3">
              <label for="" class="form-label">Phone Number*</label>
              <input type="text" class="form-control" name="phone_number" value="" id="" placeholder="Your Phone number*" required>
          </div>
          <div class="mb-3">
              <label for="" class="form-label">Email Address*</label>
              <input type="text" class="form-control" name="email" value="" id="" placeholder="Your email address*" required>
          </div>
          
         
          <label for="" class="form-label">Area*</label><br>
                <select name="area" id="" class="form-control input">
                ...
                <div class="mb-3 mt-3">
                  ...
                  <input type="text" class="form-control" name="total_ammount" value="" id="" placeholder="Your total ammount*" required>
              </div>
                <div class="mb-3">
                  <label for="" class="form-label">Address*</label>
                  <textarea class="form-control" name="address" id="" placeholder="Your full address*"></textarea>
              </div>
          <button type="submit" name="submit" class="btn button-1">Confirm Order</button>
